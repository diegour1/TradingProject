# -*- coding: utf-8 -*-
"""longshort-crossentity-algo.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1bkK_hPdI0R72oEBjyokufQ3L9yY8qfsh
"""
...
def make_pipeline():
    ...
    pcf_ratio = Fundamentals.pcf_ratio.latest
    ...
    invested_capital_winsorized = invested_capital.winsorize(min_percentile=0.05, max_percentile=0.95)
    pb_ratio_winsorized = pb_ratio.winsorize(min_percentile=0.05, max_percentile=0.95)
    pcf_ratio_winsorized = pcf_ratio.winsorize(min_percentile=0.05, max_percentile=0.95)
    ...
    combined_factor = (
        ...
        value_score.zscore() +
        invested_capital_winsorized.zscore() +
        pb_ratio_winsorized.zscore() +
        pcf_ratio_winsorized.zscore() +
